...
def documents():
    documents = []
    document_1 = Document("NN00100.xml", "title 1", "body text 1")
    documents.append(document_1)
    document_2 = Document("NN00200.xml", "title 2", "body text 2")
    documents.append(document_2)
    document_3 = Document("NN00300.xml", "title 3", "body text 3")
...
@patch(
    "podium.preproc.lemmatizer.croatian_lemmatizer._lemmatizer_posttokenized_hook",
