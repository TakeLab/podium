...
name_field = Field("Name", store_as_raw=True, tokenizer="split")

score_field = Field("Score", custom_numericalize=int, store_as_raw=True, tokenize=False)

favorite_food_field = Field("Favorite_food", store_as_raw=True, tokenize=False)
...
@pytest.mark.parametrize(
    "expected_values",
    [
        {"Name": "Mark Dark", "Score": 5, "Favorite_food": "Hawaiian pizza"},
        {"Name": "Stephen Smith", "Score": 10, "Favorite_food": "Fried squid"},
        {"Name": "Ann Mann", "Score": 15, "Favorite_food": "Tofu"},
    ],
)
...
@pytest.mark.parametrize(
    "expected_values, example_xml_string",
    [
        (
            {"Name": "Mark Dark", "Score": 5, "Favorite_food": "Hawaiian pizza"},
            "<Example>"
...
@pytest.mark.parametrize(
    "expected_values, example_json_string",
    [
        (
            {"Name": "Mark Dark", "Score": 5, "Favorite_food": "Hawaiian pizza"},
            "{"
...
@pytest.mark.parametrize(
    "expected_values, example_csv_string",
    [
        (["Mark Dark", 5, "Hawaiian pizza"], "Mark Dark,5,Hawaiian pizza"),
        (["Stephen Smith", 10, "Fried squid"], "Stephen Smith,10,Fried squid"),
        (["Ann Mann", 15, "Tofu"], "Ann Mann,15,Tofu"),
    ],
)
...
@pytest.mark.parametrize(
    "expected_values, example_tsv_string",
    [
        (["Mark Dark", 5, "Hawaiian pizza"], "Mark Dark\t5\tHawaiian pizza"),
        (["Stephen Smith", 10, "Fried squid"], "Stephen Smith\t10\tFried squid"),
        (["Ann Mann", 15, "Tofu"], "Ann Mann\t15\tTofu"),
