...
from takepod.models import ModelPipeline
...
def pauza_mlp_example(
    ...
    test_iter = Iterator(batch_size=10)
    ...
    model_pipeline = ModelPipeline(
        ...
        trainer=trainer,
        iterator=train_iter,
        batch_to_tensor=batch_transform_function
    )
    ...
    test_batch = next(iter(SingleBatchIterator(test_set)))
    x_test, y_test = batch_transform_function(*test_batch)
    prediction = model_pipeline.predict(test_set)[model.PREDICTION_KEY]
