...
import tempfile
import pytest
from takepod.datasets.impl.snli_dataset import SNLISimple, SNLIDataset
...
TRAIN_EXAMPLES_SIMPLE = [
    ...
    '"sentence2": "Vestibulum vehicula, eros at bibendum convallis, nulla eros luctus dui."}',
    '{"gold_label": "contradiction", "sentence1": "Fusce vehicula suscipit diam eu posuere. Aliquam ante diam.", '
    '"sentence2": "Mauris eros libero, mattis quis odio ut, dictum consequat lorem."}'
]

EXPECTED_EXAMPLES_SIMPLE = [
    {"gold_label": "neutral",
     "sentence1": "Lorem ipsum dolor sit amet, consectetur adipiscing elit.".split(),
     "sentence2": "Vestibulum vehicula, eros at bibendum convallis, nulla eros luctus dui.".split()},
    {"gold_label": "contradiction",
     "sentence1": "Fusce vehicula suscipit diam eu posuere. Aliquam ante diam.".split(),
     "sentence2": "Mauris eros libero, mattis quis odio ut, dictum consequat lorem.".split()}
]
...
def test_default_fields():
    ...
    assert len(fields) == 3
    field_names = [
                   SNLISimple.GOLD_LABEL_FIELD_NAME,
...
def test_load_dataset(mock_dataset_path):
    ...
    for ex in dataset:
        ex_data = {"gold_label": ex.gold_label[0], "sentence1": ex.sentence1[1], "sentence2": ex.sentence2[1]}
