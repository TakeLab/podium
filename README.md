...
Our goal is to accelerate users' development of NLP models whichever aspect of the library they decide to use. We desire the library to be **lightweight**, in terms of code and dependencies, **flexible**, to cover most common use-cases and easily adapt to more specific ones and **clearly defined**, so new users can quickly understand the sequence of operations and how to inject their custom functionality.
